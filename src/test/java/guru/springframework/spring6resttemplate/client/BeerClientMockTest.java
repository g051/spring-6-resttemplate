...
public class BeerClientMockTest {
  ...
  static final String BEARER_VALUE = TokenType.BEARER.getValue() + " " + TOKEN;;
...
//    }
  ...
  void setUp() throws JsonProcessingException {
    ...
    var token = new OAuth2AccessToken(TokenType.BEARER, TOKEN, Instant.MIN, Instant.MAX);
  ...
  void testListBeersWithQueryParam() throws JsonProcessingException {
    ...
    server.expect(method(HttpMethod.GET))
        ...
        .andExpect(header("Authorization", BEARER_VALUE))
